/** Shared icon set for the desktop kit. Lucide-style, 1.5px stroke, currentColor. */
const Icon = ({ name, size = 16, ...rest }) => {
  ...
  switch (name) {
    ...
    case "user": return (<svg {...common}><circle cx="12" cy="7" r="4"/><path d="M5.5 21a6.5 6.5 0 0 1 13 0"/></svg>);
